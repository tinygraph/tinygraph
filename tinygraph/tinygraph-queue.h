...
typedef const struct tinygraph_queue* tinygraph_queue_const_s;
...
TINYGRAPH_WARN_UNUSED
tinygraph_queue_s tinygraph_queue_copy(tinygraph_queue_const_s queue);
...
TINYGRAPH_WARN_UNUSED
uint32_t tinygraph_queue_get_front(tinygraph_queue_const_s queue);

TINYGRAPH_WARN_UNUSED
uint32_t tinygraph_queue_get_back(tinygraph_queue_const_s queue);

TINYGRAPH_WARN_UNUSED
uint32_t tinygraph_queue_get_size(tinygraph_queue_const_s queue);

TINYGRAPH_WARN_UNUSED
uint32_t tinygraph_queue_get_capacity(tinygraph_queue_const_s queue);

TINYGRAPH_WARN_UNUSED
bool tinygraph_queue_is_empty(tinygraph_queue_const_s queue);
...
void tinygraph_queue_print_internal(tinygraph_queue_const_s queue);
