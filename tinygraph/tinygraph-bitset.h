...
typedef const struct tinygraph_bitset* tinygraph_bitset_const_s;
...
TINYGRAPH_WARN_UNUSED
tinygraph_bitset_s tinygraph_bitset_copy(tinygraph_bitset_const_s bitset);
...
TINYGRAPH_WARN_UNUSED
bool tinygraph_bitset_get_at(tinygraph_bitset_const_s bitset, uint64_t i);

TINYGRAPH_WARN_UNUSED
uint64_t tinygraph_bitset_get_size(tinygraph_bitset_const_s bitset);
...
void tinygraph_bitset_xor(tinygraph_bitset_s bitset, tinygraph_bitset_const_s other);

void tinygraph_bitset_print_internal(tinygraph_bitset_const_s bitset);
